...
import { GiMusicalNotes, GiGalaxy, GiLipstick } from 'react-icons/gi';
...
export const footerList2 = [ 'TicTac for Good','Advertise','Developers','Transparency','TicTac Rewards' ]
